...
# --- Resolve the project-local model cache and route HF there -----------------
PROJECT_ROOT = Path(__file__).resolve().parent.parent
DEFAULT_MODELS_DIR = PROJECT_ROOT / "models"
MODELS_DIR = Path(os.environ.get("BHASHASETU_MODELS_DIR", str(DEFAULT_MODELS_DIR))).resolve()
MODELS_DIR.mkdir(parents=True, exist_ok=True)
# Keep every download inside the project for portability to an offline machine.
